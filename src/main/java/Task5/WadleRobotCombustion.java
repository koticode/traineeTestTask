...
public class WadleRobotCombustion extends WadleRobot{
    ...
    private String fuel = "горючее"; // Инкапсуляция-фиксируется значение типа топлива для этого класса.
    ...
    public WadleRobotCombustion(String purpose, String fuel) { // по этому конструктору создаются объекты - экземпляры роботов
        super(purpose, fuel);
