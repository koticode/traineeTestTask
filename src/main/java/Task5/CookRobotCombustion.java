...
public class CookRobotCombustion extends CookRobot{
    ...
    public CookRobotCombustion(String purpose, String fuel) { // по этому конструктору создаются объекты - экземпляры роботов
        super(purpose, fuel);
