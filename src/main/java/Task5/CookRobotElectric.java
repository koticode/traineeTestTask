...
public class CookRobotElectric extends CookRobot{
    ...
    public CookRobotElectric(String purpose, String fuel) { // по этому конструктору создаются объекты - экземпляры роботов
        super(purpose, fuel);
