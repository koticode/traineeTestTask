...
public class WadleRobotNuclear extends WadleRobot{
    ...
    public WadleRobotNuclear(String purpose, String fuel) { // по этому конструктору создаются объекты - экземпляры роботов
        super(purpose, fuel);
